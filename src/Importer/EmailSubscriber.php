...
class EmailSubscriber
{
    ...
    protected function unregisterEmails()
    {
        ...
        $config = [
            ...
            'wpas_ticket_after_update_admin_success' => ['wpas_notify_admin_assignment', 12, 3],
            'wpas_post_new_ticket_admin'             => ['wpas_notify_admin_new_ticket', 12, 1],
            'wpas_insert_reply_admin_success'        => ['wpas_notify_admin_reply', 10, 3],
            'wpas_ticket_closed_by_agent'            => ['wpas_notify_ticket_closed_by_agent', 12, 1],
            'wpas_add_reply_complete'                => ['wpas_notify_reply', 10, 2],
            'wpas_after_close_ticket'                => ['wpas_notify_close', 10, 3],
